...
t)t) select empleados.nombre , empleados.apellido, departamentos.nombre from empleados inner join departamentos on empleados.departamento= departamentos.departamento_id 
order by departamentos.nombre asc, empleados.apellido, empleados.nombre ;
...
x)select empleados.*
from empleados inner join departamentos on empleados.departamento = departamentos.departamento_id and departamentos.nombre= "I+D"  
order by empleados.nombre, apellido.
y) select empleados.*
from empleados inner join departamentos on empleados.departamento = departamentos.departamento_id and departamentos.nombre in ("I+D", "Contabilidad", "Sistemas") 
order by empleados.nombre, apellido
z)select empleados.nombre , departamentos.nombre from empleados inner join departamentos on empleados.departamento= departamentos.departamento_id   where presupuesto in('280000',375000,0)
